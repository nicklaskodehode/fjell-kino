...
function App() {
  ...
  return (
    <div>
      <Navbar />
      <Routes>
        <Route path='/fjell-kino' element={<Home setSelectedMovie={setSelectedMovie} setSelectedTime={setSelectedTime} selectedMovie={selectedMovie} selectedTime={selectedTime}/>}></Route>
